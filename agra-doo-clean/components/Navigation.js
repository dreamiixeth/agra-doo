...
export default function Navigation({ 
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#e8edf0] shadow-md z-50">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-green-300">AGRA d.o.o.</h1>
          ...
          <div className="flex items-center gap-4">
            ...
            {currentView !== 'home' && (
              <button
                ...
                className="md:hidden p-2 text-zinc-400 hover:text-green-300"
              >
            ...
            <a 
              href="tel:031574730" 
              className="hidden lg:flex items-center gap-2 text-green-300 hover:text-green-300 transition-colors"
            >
