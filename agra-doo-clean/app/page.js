            ...
            <div className="flex flex-col space-y-1 pt-4">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="px-4 py-3 text-[#1A1A1A] hover:bg-[#1A1A1A]/5 rounded-lg font-semibold text-sm tracking-wide transition-colors"
                >
                  {link.name}
                </Link>
              ))}
              <a
                href="tel:031574730"
                className="mx-4 mt-3 flex items-center justify-center gap-2 bg-[#E0A800] text-[#1A1A1A] font-semibold px-6 py-3 rounded-lg text-sm"
              >
                📞 031 574 730
              </a>
            </div>
